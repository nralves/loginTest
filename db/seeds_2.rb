...
Lecturer.create(
				[
					...
					of the Victorian Branch of the Australian Society of Archivists.',
					image: File.open(Rails.root.join('public/images/lecturers/AdelaideParr-2013.jpg'))}, 
					...
					image: File.open(Rails.root.join('public/images/lecturers/AlexMcEwen-2013.jpg')) },
					...
					image: File.open(Rails.root.join('public/images/lecturers/AndyCarnahan-2013.jpg')) },
					...
					image: File.open(Rails.root.join('public/images/lecturers/AnneCornish-2013.jpg')) },
					...
					image: File.open(Rails.root.join('public/images/lecturers/StephenLudlow-2013.jpg')) },
					...
					image: File.open(Rails.root.join('public/images/lecturers/JohnMcMillan-2013.jpg'))},
					...
					image: File.open(Rails.root.join('public/images/lecturers/RoryStaunton-2013.jpg')) }
...
Conference.create(
				 [
					...
					logo: File.open(Rails.root.join('public/images/conferences/inforum2013.png'))}
