...
Lecturer.create(
				[
					...
					of the Victorian Branch of the Australian Society of Archivists.', image: File.open(File.join(Rails.root, '/public/images/lecturers/AdelaideParr-2013.jpg')) }, 
					...
					ISO46/SC11 International Standard on Records Management (now known as ISO 15489).', image: File.open(File.join(Rails.root, '/public/images/lecturers/AnneCornish-2013.jpg')) },
					...
					Before joining OpenText, Stephen was an Information Management consultant focused on Canadian Federal Government clients.', image: File.open(File.join(Rails.root, '/public/images/lecturers/StephenLudlow-2013.jpg')) },
					...
					John was a founding member in the 1970s of the Freedom of Information Campaign Committee, which led the public campaign for enactment of the Freedom of Information Act 1982. He is a National Fellow of the Institute of Public Administration Australia; a Fellow of the Australian Academy of Law; and former President of the Australian Institute of Administrative Law.', image: File.open(File.join(Rails.root, '/public/images/lecturers/JohnMcMillan-2013.jpg')) },
					...
					Rory is formally a International Board member and is a Fellow of AIIM International, the USA-based Association for Enterprise Content Management, and is member of the Executive Committee of the DLM Forum, the European Commission-sponsored body that generates information standards in Europe. ', image: File.open(File.join(Rails.root, '/public/images/lecturers/RoryStaunton-2013.jpg')) }
...
Conference.create(
				 [
					...
					{name:'inForum 2013', begin:'2013-09-08', end:'2013-09-11', location:' Canberra, Australia',  logo: File.open(File.join(Rails.root, '/public/images/conferences/inforum2013.png'))}
